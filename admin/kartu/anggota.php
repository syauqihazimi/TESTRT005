	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" value="<?php echo $data_cek['alamat']; ?> , RT <?php echo $data_cek['rt']; ?> RW <?php echo $data_cek['rw']; ?>"
					 readonly/>
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" value="Ds. <?php echo $data_cek['desa']; ?> ,Kec. <?php echo $data_cek['kec']; ?>"
					 readonly/>
				</div>
				<div class="col-sm-4">
					<input type="text" class="form-control" value="Kab. <?php echo $data_cek['kab']; ?>, Prov. <?php echo $data_cek['prov']; ?>"
					 readonly/>
				</div>
			</div>
			<div class="form-group row">
