...
<?php
          if ($data_level=="Administrator" || $data_level=="Ketua RT" ){
        ?>
			<div class="form-group row">
                ...
                if ($data_cek['level'] == "Ketua RT") echo "<option value='Ketua RT' selected>Ketua RT</option>";
                else echo "<option value='Ketua RT'>Ketua RT</option>";
