...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="index.php" class="nav-link">
						<font color="white">
							<b>Sistem Informasi Rukun Tetangga (SiReTe) </b>
						</font>
					</a>
				</li>
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				...
				<span class="brand-text"> SiReTe 05 </span>
			</a>
	...
	<li class="nav-item has-treeview">
						...
						<li class="nav-item">
							<a href="?page=profil-pengguna" class="nav-link">
								<i class="nav-icon far fa-circle text-warning"></i>
								<p>
									Pofil
								</p>
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
				...
				case 'profil-pengguna':
					include "admin/pengguna/profil_pengguna.php";
					break;
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				...
				<a target="_blank" href="https://www.instagram.com/bagus_satoto1/">
					<strong> Glina HK</strong>
				</a>
				All rights reserved.
			</div>
			<b>Ikatan Remaja RT 005</b>
		</footer>
