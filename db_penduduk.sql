...
CREATE TABLE `tb_pengguna` (
  ...
  `level` enum('Administrator','Ketua RT','Sekretaris','Bendahara') NOT NULL,
...
INSERT INTO `tb_pengguna` (`id_pengguna`, `nama_pengguna`, `username`, `password`, `level`, `status`) VALUES
(1, 'Brodol', 'admin', 'admin', 'Administrator', 'aktif'),
(3, 'Kang Emon', 'Sek1', 'Sek1', 'Sekretaris', 'aktif'),
(10, 'Bendahara 1', 'Ben1', 'Ben1', 'Bendahara', 'aktif'),
(11, 'RT01', 'RT01', 'RT01', 'Ketua RT', 'aktif'),
(20, 'coba', 'coba', 'coba', 'Sekretaris', 'tidak aktif');
...
--
ALTER TABLE `tb_lahir`
  MODIFY `id_lahir` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
